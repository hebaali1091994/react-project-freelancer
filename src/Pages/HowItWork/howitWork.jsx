    ...
    return (
        <div>
          ...
          <Header/>
                                <div class="container">
                                <div class="row">
                                <div class=" col-xl-5 col-md-6 col-sm-12 mt-5 text-white ">
                                <h2 class="header-title">How can freelancers help your business?
                                </h2>
                                <p class="header-paragraph">The possibilities are endless. We have expert freelancers who work in every technical, professional, and creative field imaginable.</p>
                                <a href="#" class="btn btn-primary btn-lg Color-button" tabindex="-1" role="button" > Post a Project </a>

                                </div>
                                <div class=" col-xl-5 col-md-6 col-sm-12"></div>
                                </div>
                                <div class="row g-0">
                                <div class="col-xl-3 flex-grow-1"></div>
                                <div class="col-xl-8 col-sm-12 nav-tab-new-future">
                                <nav>
                    ...
                    <div class="container">
                    <div class="mt-5">
                    <h2 class="headertitle">Choose from endless possibilities</h2>
                    ...
                    <a href="#" class="btn btn-primary btn-lg background-master" tabindex="-1" role="button" > Post a Project </a>
                    </div>
                    </div>
                    ...
                    <h2 class="header-title">Be in control. Keep in contact</h2>
                    ...
                    <div class="container">
                    <div class=" col-md-6 col-sm-12 mt-5 text-white ">
                    <h2 class="header-title">So what are you waiting for?

                    </h2>
                    <p class="header-paragraph">Post a project today and get bids from talented freelancers.
                    </p>
                    <a href="#" class="btn btn-primary btn-lg Color-button" tabindex="-1" role="button" > Post a Project </a>
                    ...
                    <div class="blog">
                    <div class="container">
                    <h2 class="header-title">Still not convinced? Check out the results!


                    </h2>
                    <p class="header-paragraph">Here are just some of the things you could get done on Freelancer.com. For more completed projects, visit our Project Showcase.

                    </p>
                    <div class="row mt-5">
                    <div class="col-xl-4 col-md-6 col-sm-12 article">
                    <img class="img-size" src="../image/fristImage.png" alt=""/>
                    ...
                    <div class="col-xl-4 col-md-6 col-sm-12 article-button">
                    <a href="#" class="btn btn-primary btn-lg Color-button" tabindex="-1" role="button" > View More Projects  </a>
                    </div>
                    <div class="col-xl-4 col-md-6 col-sm-12 "></div>
                    </div>
                    </div>
                    ...
                    <div class="container">
                    <div class=" col-md-6 col-sm-12 mt-5 text-white ">
                    <h2 class="header-title">Additional Help
                    </h2>
                    <p class="header-paragraph">Not sure where to start? Check out the links below:
                    </p>

                    </div>
                    <div class="row">
                    <div class=" col-md-4 col-sm-12 mt-5 text-white ">
                    <a href="#"> How to Hire with Freelancer.com </a>
                    </div>
                    <div class=" col-md-4 col-sm-12 mt-5 text-white ">
                    <a href="#"> Tips for posting projects </a>
                    </div>
                    <div class=" col-md-4 col-sm-12 mt-5 text-white "></div>
                    <div class=" col-md-4 col-sm-12 mt-5 text-white ">
                    ...
                    <div class="row">
                        ...
                        <a href="#" class="btn btn-primary btn-lg background-master" tabindex="-1" role="button" >  Browse Jobs  </a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                    <div class="col-md-6 col-sm-12">
                    <h2 class="header-title">Manage Your Career</h2>
                    ...
                    <div class="row mt-5">
                    <div class="col-xl-4 col-md-6 col-sm-12 article">
                    <img class="img-size" src="../image/testimonial-federico.jpg" alt=""/>
