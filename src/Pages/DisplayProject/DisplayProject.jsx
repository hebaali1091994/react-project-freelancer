...
const DisplayProject = () => {
  ...
  // useEffect(() => {
  //   const fetchProject = async () => {
  //     const res = await axios.post("/Project/filter",filtername);
  //     setProject(res.data);
  //   };
  //   fetchProject();
  // }, []);
              ...
              <div class="container ">
                ...
                <nav>
                  <div class="nav nav-tabs mt-3" id="nav-tab" role="tablist">
                    <button
                      class="nav-link col-2  active text-white"
                      id="nav-home-tab"
                      data-bs-toggle="tab"
                    ...
                    <button
                      class="nav-link col-2   text-white"
                      id="nav-profile-tab"
                      data-bs-toggle="tab"
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-3 filter-freelancer">
                ...
                <div class="row">
                  ...
                  <div class=" mb-3 col-md-4">
                    <div class="row">
                      ...
                      <input
                        type="text"
                        onChange={minhour} name="filtername"
                        class="form-control w-75"
                        aria-label="Amount (to the nearest dollar)"
                      />
                    </div>
                  </div>
                  <div class="col-md-2 to-max">to</div>
                  <div class=" mb-3 col-md-4">
                    <div class="row">
                      <span class="input-group-text w-25">$</span>
                      <input
                ...
                <h5 class="text-left mt-3">Client's country</h5>
                <div class="input-group mb-3">
                  <span class="input-group-text" id="basic-addon1">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                ...
                <h4 for="customRange2" class="form-label">
                  Reviews
                </h4>
                <input
                  type="range"
