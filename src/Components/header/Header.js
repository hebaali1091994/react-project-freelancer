...
import '../../i18n'
import { Call, ChatBubbleOutlineOutlined, ExploreOutlined, LocalMallOutlined, NotificationsOutlined, PeopleOutlined } from '@material-ui/icons';
        ...
        <div className="container">
          <nav className="navbar navbar-expand-lg navbar-light">
            <div className="container-fluid p-0">
              <Link to="/"><img src={Freelancerlogo} className="image-w" /></Link>
              <button
              ...
              <div className="collapse navbar-collapse" id="navbarSupportedContentheader">
                <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                  ...
                  <li className="nav-item">
                    <Link className='link ms-4' to="/Contactus">  <Call></Call>  Contact Us  </Link>
