...
const ContestTwo = ({ Data, setData }) => {
    ...
    return (
        <>
        <div className="row  g-1 d-flex justify-content-evenly mt-3">
            ...
            <div className="row">
              ...
              <div className="col-md-6">
                ...
                <p style={{ fontSize: "1rem" }}>
                  Attract higher quality entries from freelancers. Moneyback
                  guarantee is not applicable if a contest is guaranteed.
                </p>
              </div>
            </div>
          </div>
          <div id="start" className="Basic col-md-5 shadow p-3   rounded disabled">
            <div className="row">
              <div className="col-md-6 d-flex justify-content-center align-content-center">
