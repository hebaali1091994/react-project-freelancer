...
const ContestOne = ({ Data, setData }) => {
    ...
    return (
        ...
        <div className="row g-1 d-flex justify-content-evenly mt-5">
          <div className=" col-xs-12  col-sm-12 col-md-12 col-lg-12 mb-5">
            <p class="m-auto" style={{fontSize: "1.3rem", width: "50vw"}}>
              <b>What type of contest do you want to run?</b>
            </p>
          </div>
          <div id="post"className=" col-xs-12 col-sm-12 col-md-5 shadow   bg-body rounded" onClick={() => submit(1)}>
            <div className="row">
              <div className=" col-xs-12 col-sm-12 col-md-5 d-flex justify-content-center align-content-center">
                <img className="img-fluid w-50"src={fixedpriceproject}alt=""/>
              </div>
              <div className="col-xs-12 col-sm-12 col-md-7">
                <p className="fs-6">
                  <b>Guaranteed contest</b>
                </p>
                <p>
                  Attract higher quality entries from freelancers.
                  Moneyback
                  guarantee is not applicable if a contest is guaranteed.
                </p>
              </div>
            </div>
          </div>
          <div id="start"className="col-xs-12 col-sm-12 col-md-5 shadow p-3  bg-body rounded"onClick={() => submit(2)}>
            <div className="row">
              ...
              <div className="col-ms-5 col-md-6">
                <p style={{ fontSize: "1.1rem" }}>
                  <b>Basic contest</b>
                </p>
                <p>
                  Start getting entries.Award your favorites. Money back
                  guarantee.
                </p>
              </div>
            </div>
  ...
  {/* --------------------------------------------------------2-------------------------------------------------*/}
                  ...
                  <div className="row">
                         ...
                         onChange={onCheck2}
                           id="FEATURED"/>
                         <p><b>1,500.00{Data.CurrencyCode}</b></p> 
                              </label>
                           </div>
                          </div>
  ...
  {/* --------------------------------------------------------4-------------------------------------------------*/}
                  ...
                  <div className="row">
                         ...
                         onChange={onCheck4}
                          id="HIGHLIGHT"/>
                         <p><b>750.00{Data.CurrencyCode}</b></p> 
                              </label>
                           </div>
                          </div>
  ...
  {/* --------------------------------------------------------6-------------------------------------------------*/}
                  ...
                  <div className="row">
                         ...
                         <input class="form-check-input" type="checkbox" 
                          ...
                          onChange={onCheck6}
                          id="NDA"/>
                         <p><b>1,000.00 {Data.CurrencyCode}</b></p> 
                              </label>
                           </div>
                          </div>
                          <div className="col-md-4 mx-auto">
